  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
            <a href="<?php echo base_url() ?>direktur/dashboard">
          ...
          <ul class="treeview-menu"> -->
            <li >
              <a href="<?php echo base_url() ?>direktur"><i class="fa fa-user"></i>Data Karyawan
                <small class="label pull-right bg-red">

                  <?php

                  $ci = get_instance();
                  $data = $ci->db->query("SELECT COUNT(direktur_cek) AS jml_blm FROM data_karyawan WHERE direktur_cek =  '12' OR direktur_cek ='11'")->result_array();
                  echo $data[0]['jml_blm'];
                   ?>
                </small>
              </a></li>
