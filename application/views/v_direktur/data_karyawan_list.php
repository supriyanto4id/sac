            ...
            <div class='col-xs-12'>
              <div class='box'>
                <div class='box-header'>
                  <h3 class='box-title'>DATA_KARYAWAN LIST
                    <!-- <?php echo anchor('data_karyawan/create/','Create',array('class'=>'btn btn-danger btn-sm'));?> -->
              		<?php echo anchor(site_url('data_karyawan/excel'), ' <i class="fa fa-file-excel-o"></i> Excel', 'class="btn btn-primary btn-sm"'); ?>
              		<?php echo anchor(site_url('data_karyawan/word'), '<i class="fa fa-file-word-o"></i> Word', 'class="btn btn-primary btn-sm"'); ?>
              		<?php echo anchor(site_url('data_karyawan/pdf'), '<i class="fa fa-file-pdf-o"></i> PDF', 'class="btn btn-primary btn-sm"'); ?></h3>
                </div><!-- /.box-header -->
                <div class='box-body'>
	    ...
	    <tbody>
          ...
          <td> <?php
           if ($data_karyawan->direktur_cek == 10 ){
              echo "Setuju";
            }else if  ($data_karyawan->direktur_cek == 11){
              echo "Tidak Setuju";
            }else if($data_karyawan->direktur_cek == 12){
              echo "Proses";
            }
           ?>
        ...
        <td>
          <?php
           ...
           ?>
			...
			<?php
			echo anchor(site_url('direktur/read_all_index/'.$data_karyawan->id_karyawan),'<i class="fa fa-eye"></i>',array('title'=>'detail','class'=>'btn btn-danger btn-sm'));
		//	echo '  ';
