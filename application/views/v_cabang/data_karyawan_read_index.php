                ...
                <div class='box-header'>
                  <h3 class='box-title'>Data_karyawan Read</h3>
                    ...
                    <table class="table table-bordered">
                      ...
                      <tr><td></td><td><a href="<?php echo site_url('cabang/update/'.$data_karyawan->id_karyawan)?>" class="btn btn-warning">Edit</a> <a href="<?php echo site_url('cabang') ?>" class="btn btn-default">Cancel</a></td></tr>
                  ...
                  <div class='box'>
                    <div class='box-header'>
                      ...
                      <div class="box-tools pull-right">
                            ...
                            <a href="<?php echo site_url('cabang/create_inventaris_karyawan/'.$data_karyawan->id_karyawan) ?>" class="btn btn-primary btn-sm">Add</a>
                        ...
                        echo anchor(site_url('cabang/delete_inventaris/'.$data_inventaris->id_inventaris_karyawan),'<i class="fa fa-trash-o"></i>','title="delete" class="btn btn-danger btn-sm" onclick="javasciprt: return confirm(\'Are You Sure ?\')"');
                        ?>
                          </td>
                            </tr>
                                  <?php
                  ...
                  <div class='box'>
                    <div class='box-header'>
                      ...
                      <div class="box-tools pull-right">
                              ...
                              <a href="<?php echo site_url('cabang/create_data_bpjs/'.$data_karyawan->id_karyawan) ?>" class="btn btn-primary btn-sm">Add</a>
                                ...
                                <tr>
                                  ...
                                  <td style="text-align:center" width="140px">
                                    <?php
                                      ...
                                      // echo '  ';
                                      echo anchor(site_url('cabang/delete_bpjs/'.$data_bpjs->id_databpjs),'<i class="fa fa-trash-o"></i>','title="delete" class="btn btn-danger btn-sm" onclick="javasciprt: return confirm(\'Are You Sure ?\')"');
                                      ?>
                                </td>
                               </tr>
                                <?php
