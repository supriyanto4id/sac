      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          ...
          <ul class="treeview-menu">
            <li ><a href="<?php echo base_url() ?>data_karyawan"><i class="fa fa-circle-o"></i>Data Karyawan</a></li>
...
<script>
  ...
  $(document).ready(function(){
      ...
      $('#submit').click(function(){
           $.ajax({
                url:"<?php echo base_url()?>data_karyawan/create_data_bpjs_action",
                method:"POST",
                ...
                success:function(data)
                {
                   ...
                   window.location = "<?php echo base_url()?>data_karyawan/create_data_bpjs_action";
                }
 ...
 $("#demo2").maskMoney({prefix:'Rp ', allowNegative: true, thousands:'.', decimal:',', affixesStay: false});
 $("#demo3").maskMoney({prefix:'Rp ', allowNegative: true, thousands:'.', decimal:',', affixesStay: false});
 $("#demo4").maskMoney({prefix:'Rp ', allowNegative: true, thousands:'.', decimal:',', affixesStay: false});
 $("#demo5").maskMoney({prefix:'Rp ', allowNegative: true, thousands:'.', decimal:',', affixesStay: false});
 $("#demo6").maskMoney({prefix:'Rp ', allowNegative: true, thousands:'.', decimal:',', affixesStay: false});
 $("#demo7").maskMoney({prefix:'Rp ', allowNegative: true, thousands:'.', decimal:',', affixesStay: false});
</script>
