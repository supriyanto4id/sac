  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
            <a href="<?php echo base_url() ?>data_karyawan/dashboard">
          ...
          <li class="treeview">
          <a href="#">
            <i class="fa fa-user"></i> <span>KARYAWAN
            <small class="label pull-center bg-red">
              <?php
              $ci = get_instance();
              $data = $ci->db->query("SELECT COUNT(direktur_cek) AS jml_blm FROM data_karyawan WHERE hrd_cek =  '12' OR hrd_cek ='11'")->result_array();
              echo $data[0]['jml_blm'];
               ?>
            </small></span>
...
<script>
  ...
  $('select.status').on('change',function () {
          ...
          // alert(decision);
          // alert(id);
         window.location = '<?php echo base_url()?>data_karyawan';
          $.ajax({
                   type: "POST",
                   url: "<?php echo base_url()?>data_karyawan/hrd_cek",
